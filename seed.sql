INSERT OR REPLACE INTO menu_items (id, category, name, description, price, tags, available, position) VALUES
  ...
  ('restaurant-ditor', 'mains', 'Restaurant ditor', 'Opsione restaurant dhe tavolina me rezervim. Kontaktoni stafin per disponueshmerine.', 'Sipas kerkeses', 'Restaurant', 1, 4),
  ('bar-pije', 'drinks', 'Bar dhe pije', 'Sherbim bari per evente, darka familjare dhe vizita te perditshme.', 'Sipas kerkeses', 'Bar, Evente', 1, 5),
  ('whatsapp-oferte', 'drinks', 'Kerko oferte ne WhatsApp', 'Per menu, cmime dhe detaje eventesh, na shkruani direkt ne WhatsApp ose telefononi.', '+355 686264646', 'Kontakt', 1, 6);
